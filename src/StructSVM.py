...
# testing_X = np.load('testing_input.npy',allow_pickle=True)[:test_batch_size]
# print(testing_X.shape)

# joints_info = np.load('joints_information.npy',allow_pickle=True)
# x_cords_train = joints_info[0][1800:1800+test_batch_size]
# print(x_cords_train.shape)
# y_cords_train = joints_info[1][1800:1800+test_batch_size]
# print(y_cords_train.shape)
...
# np.save('StructSVM_predictions_150_20.npy',solutions)